...
<head>
    ...
    <title>Engineering Borrowing System — Admin</title>
...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?= base_url('Borrowing-System?meaction=ADMIN-DASHBOARD') ?>"
        ...
        <a href="<?= base_url('Borrowing-System?meaction=ADMIN-TOOLS') ?>"
            class="<?= (isset($active_page) && $active_page == 'tools') ? 'active' : '' ?>">
            <i class="bi bi-tools"></i> Tools
        </a>
        <a href="<?= base_url('Borrowing-System?meaction=ADMIN-BORROWINGS') ?>"
            class="<?= (isset($active_page) && $active_page == 'borrowings') ? 'active' : '' ?>">
            <i class="bi bi-clipboard-check"></i> Borrowings
        </a>
        <a href="<?= base_url('Borrowing-System?meaction=ADMIN-STUDENTS') ?>"
            class="<?= (isset($active_page) && $active_page == 'students') ? 'active' : '' ?>">
            <i class="bi bi-people"></i> Students
        </a>

        <div class="nav-section">System</div>
        <a href="<?= base_url('Borrowing-System?meaction=ADMIN-PROFILE') ?>"
